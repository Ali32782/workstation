...
def write_uebersicht(wb, ua_data, rl_data, hy_data, inv_data, fit_data, today_str):
    ...
    a_rows = [
        ...
        ("Krankheitstage",        r(jan_t.get("krank",0)), r(feb_t.get("krank",0)),
                                  r(jan_t.get("krank",0)+feb_t.get("krank",0)), "0.0"),
        ("Fitnesskurse (Tage)",   r(jan_t.get("kurse",0)), r(feb_t.get("kurse",0)),
                                  r(jan_t.get("kurse",0)+feb_t.get("kurse",0)), "0.0"),
        ("Marketing (Tage)",      r(jan_t.get("mktg",0)),  r(feb_t.get("mktg",0)),
                                  r(jan_t.get("mktg",0)+feb_t.get("mktg",0)),  "0.0"),
        ("Laufanalyse (Tage)",    r(jan_t.get("lauf",0)),  r(feb_t.get("lauf",0)),
                                  r(jan_t.get("lauf",0)+feb_t.get("lauf",0)),  "0.0"),
        ("Management (Tage)",     r(jan_t.get("mgmt",0)),  r(feb_t.get("mgmt",0)),
                                  r(jan_t.get("mgmt",0)+feb_t.get("mgmt",0)),  "0.0"),
        ("Abwesenheiten Total",
         r(sum(jan_t.get(k,0) for k in ["krank","kurse","mktg","lauf","mgmt"])),
         r(sum(feb_t.get(k,0) for k in ["krank","kurse","mktg","lauf","mgmt"])),
         r(sum(jan_t.get(k,0)+feb_t.get(k,0) for k in ["krank","kurse","mktg","lauf","mgmt"])), "0.0"),
