  ...
  corehub: {
    ...
    apps: [
      ...
      },
      {
        ...
        url: "https://sign.kineo360.work/sso-bridge.html",
        icon: PenLine,
        embed: "iframe",
      },
      {
        ...
        name: "Calls",
        section: "Kommunikation",
        description: "Jitsi Meet · Spontan-Calls & geplante Meetings",
        url: "https://meet.kineo360.work",
        icon: Video,
        embed: "iframe",
      },
      {
  ...
  medtheris: {
    ...
    apps: [
      ...
      },
      {
        ...
        url: "https://support.medtheris.kineo360.work",
        icon: HeadphonesIcon,
        embed: "iframe",
      },
      {
      ...
      },
      {
        ...
        name: "Calls",
        section: "Kommunikation",
        description: "Jitsi Meet · Demo-Calls & Sales-Meetings",
        url: "https://meet.kineo360.work",
        icon: Video,
        embed: "iframe",
      },
  ...
  kineo: {
    ...
    apps: [
      ...
      },
      {
        ...
        name: "Calls",
        section: "Kommunikation",
        description: "Jitsi Meet · 1:1s, Workshops, Strategie-Calls",
        url: "https://meet.kineo360.work",
        icon: Video,
        embed: "iframe",
      },
